...
%
%   - @oparam [struct wre] Grid: structure containing the parameters of the generated grid:
%
...
%     the grid (optional)
%
%       -> [float er] TopRight: vector of UTM coordinates of the top right corner of the rectangle that
